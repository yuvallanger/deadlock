...
def _load_frequency_lists():
    data = pkg_resources.resource_string(__name__, 'generated/frequency_lists.json').decode()
...
def _load_adjacency_graphs():
    global GRAPHS
    data = pkg_resources.resource_string(__name__, 'generated/adjacency_graphs.json').decode()
